...
<html lang="en" class="light-style layout-navbar-fixed layout-wide " dir="ltr" data-theme="theme-default" data-assets-path="<?php echo site_url('assets/materio/') ?>/assets/" data-template="front-pages" data-style="light">
  ...
  <head>
	...
	<!-- Favicon -->
	<link rel="icon" type="image/x-icon" href="<?php echo site_url('assets/materio/') ?>/assets/img/favicon/favicon.ico" />
	...
	<link rel="stylesheet" href="<?php echo site_url('assets/materio/') ?>/assets/vendor/fonts/remixicon/remixicon.css" />
	
	<!-- Menu waves for no-customizer fix -->
	<link rel="stylesheet" href="<?php echo site_url('assets/materio/') ?>/assets/vendor/libs/node-waves/node-waves.css" />

	<!-- Core CSS -->
	<link rel="stylesheet" href="<?php echo site_url('assets/materio/') ?>/assets/vendor/css/rtl/core.css" class="template-customizer-core-css" />
	<link rel="stylesheet" href="<?php echo site_url('assets/materio/') ?>/assets/vendor/css/rtl/theme-default.css" class="template-customizer-theme-css" />
	<link rel="stylesheet" href="<?php echo site_url('assets/materio/') ?>/assets/css/demo.css" />
	<link rel="stylesheet" href="<?php echo site_url('assets/materio/') ?>/assets/vendor/css/pages/front-page.css" />
	<!-- Vendors CSS -->
	
	<link rel="stylesheet" href="<?php echo site_url('assets/materio/') ?>/assets/vendor/libs/nouislider/nouislider.css" />
<link rel="stylesheet" href="<?php echo site_url('assets/materio/') ?>/assets/vendor/libs/swiper/swiper.css" />

	<!-- Page CSS -->
	
<link rel="stylesheet" href="<?php echo site_url('assets/materio/') ?>/assets/vendor/css/pages/front-page-landing.css" />

	<!-- Helpers -->
	<script src="<?php echo site_url('assets/materio/') ?>/assets/vendor/js/helpers.js"></script>
	<!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
	<!--? Template customizer: To hide customizer set displayCustomizer value false in config.js.  -->
	<script src="<?php echo site_url('assets/materio/') ?>/assets/vendor/js/template-customizer.js"></script>
	<!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->
	<script src="<?php echo site_url('assets/materio/') ?>/assets/js/front-config.js"></script>
...
<script src="<?php echo site_url('assets/materio/') ?>/assets/vendor/js/dropdown-hover.js"></script>
<script src="<?php echo site_url('assets/materio/') ?>/assets/vendor/js/mega-dropdown.js"></script>
...
<span style="color:#9055FD;">
  <svg width="30" height="24" viewBox="0 0 250 196" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<path fill-rule="evenodd" clip-rule="evenodd" d="M237.721 1.18923L125 70.3075V136.87L250 65.2465V8.06814C250 3.61223 246.389 0 241.935 0C240.448 0 238.99 0.411583 237.721 1.18923Z" fill="white" fill-opacity="0.3" />
		...
		<span class="app-brand-text demo menu-text fw-semibold ms-2 ps-1">Eiger</span>
	  </a>
	</div>
...
">
			...
			<div class="row gy-4">
			  ...
			  <div class="col-lg-4 d-none d-lg-block">
				<div class="bg-body nav-img-col p-2">
				  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/misc/nav-item-col-img-light.png" class="img-fluid scaleX-n1-rtl w-100" alt="nav item col image" data-app-light-img="front-pages/misc/nav-item-col-img-light.png" data-app-dark-img="front-pages/misc/nav-item-col-img-dark.png" />
				</div>
			  </div>
			</div>
		  </div>
	...
	<ul class="navbar-nav flex-row align-items-center ms-auto">
	  ...
	  <!-- navbar button: Start -->
	  <li>
		<a href="../vertical-menu-template/auth-login-cover.html" class="btn btn-primary px-2 px-sm-4 px-lg-2 px-xl-4" target="_blank"><span class="tf-icons ri-user-line me-md-1"></span><span class="d-none d-md-block">Login/Register</span></a>
	  </li>
	  <!-- navbar button: End -->
	</ul>
	<!-- Toolbar: End -->
...
<div data-bs-spy="scroll" class="scrollspy-example">
  ...
  <section id="landingHero" class="section-py landing-hero position-relative">
	<img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/backgrounds/hero-bg-light.png" alt="hero background" class="position-absolute top-0 start-0 w-100 h-100 z-n1" data-speed="1" data-app-light-img="front-pages/backgrounds/hero-bg-light.png" data-app-dark-img="front-pages/backgrounds/hero-bg-dark.png" />
	<div class="container">
	  ...
	  <div class="position-relative hero-animation-img">
		<a href="../vertical-menu-template/dashboards-crm.html" target="_blank">
		  <div class="hero-dashboard-img text-center">
			<img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/landing-page/hero-dashboard-light.png" alt="hero dashboard" class="animation-img" data-speed="2" data-app-light-img="front-pages/landing-page/hero-dashboard-light.png" data-app-dark-img="front-pages/landing-page/hero-dashboard-dark.png" />
		  </div>
		  <div class="position-absolute hero-elements-img">
			<img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/landing-page/hero-elements-light.png" alt="hero elements" class="animation-img" data-speed="4" data-app-light-img="front-pages/landing-page/hero-elements-light.png" data-app-dark-img="front-pages/landing-page/hero-elements-dark.png" />
		  </div>
		</a>
	  </div>
	</div>
  ...
  <section id="landingFeatures" class="section-py landing-features">
	<div class="container">
	  <h6 class="text-center d-flex justify-content-center align-items-center mb-6">
		<img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/icons/section-tilte-icon.png" alt="section title icon" class="me-2" height="19" />
	  ...
	  <div class="features-icon-wrapper row gx-0 gy-12 gx-sm-6">
		<div class="col-lg-4 col-sm-6 text-center features-icon-box">
		  <div class="features-icon mb-4">
			<img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/icons/laptop-charging.png" alt="laptop charging" />
		  </div>
		...
		<div class="col-lg-4 col-sm-6 text-center features-icon-box">
		  <div class="features-icon mb-4">
			<img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/icons/transition-up.png" alt="transition up" />
		  </div>
		...
		<div class="col-lg-4 col-sm-6 text-center features-icon-box">
		  <div class="features-icon mb-4">
			<img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/icons/edit.png" alt="edit" />
		  </div>
		...
		<div class="col-lg-4 col-sm-6 text-center features-icon-box">
		  <div class="features-icon mb-4">
			<img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/icons/3d-select-solid.png" alt="3d select solid" />
		  </div>
		...
		<div class="col-lg-4 col-sm-6 text-center features-icon-box">
		  <div class="features-icon mb-4">
			<img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/icons/lifebelt.png" alt="lifebelt" />
		  </div>
		...
		<div class="col-lg-4 col-sm-6 text-center features-icon-box">
		  <div class="features-icon mb-4">
			<img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/icons/google-docs.png" alt="google docs" />
		  </div>
		...
		<div class="swiper-wrapper">
		  <div class="swiper-slide">
			<div class="card h-100">
			  <div class="card-body text-body d-flex flex-column justify-content-between text-center p-lg-8">
				<div class="mb-4">
				  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/branding/logo-4.png" alt="client logo" class="client-logo img-fluid" />
				</div>
		  ...
		  <div class="swiper-slide">
			<div class="card h-100">
			  <div class="card-body text-body d-flex flex-column justify-content-between text-center p-lg-8">
				<div class="mb-4">
				  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/branding/logo-1.png" alt="client logo" class="client-logo img-fluid" />
				</div>
		  ...
		  <div class="swiper-slide">
			<div class="card h-100">
			  <div class="card-body text-body d-flex flex-column justify-content-between text-center p-lg-8">
				<div class="mb-4">
				  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/branding/logo-3.png" alt="client logo" class="client-logo img-fluid" />
				</div>
				<p class="text-heading">
		  ...
		  <div class="swiper-slide">
			<div class="card h-100">
			  <div class="card-body text-body d-flex flex-column justify-content-between text-center p-lg-8">
				<div class="mb-4">
				  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/branding/logo-2.png" alt="client logo" class="client-logo img-fluid" />
				</div>
				<p class="text-heading">
		  ...
		  <div class="swiper-slide">
			<div class="card h-100">
			  <div class="card-body text-body d-flex flex-column justify-content-between text-center p-lg-8">
				<div class="mb-4">
				  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/branding/logo-5.png" alt="client logo" class="client-logo img-fluid" />
				</div>
				<p class="text-heading">
				  “I've never used a theme as versatile and flexible as Vuexy. It's my go to for building dashboard
				  sites on almost any project.”
			...
			<div class="card h-100">
			  <div class="card-body text-body d-flex flex-column justify-content-between text-center h-100">
				...
				<div class="text-warning mb-4">
				  ...
				  <i class="tf-icons ri-star-fill ri-24px"></i>
				  <i class="tf-icons ri-star-fill ri-24px"></i>
				  <i class="tf-icons ri-star-line ri-24px"></i>
				</div>
				<div>
				  <h6 class="mb-1">Eugenia Moore</h6>
				  <p class="mb-0 small">Founder of Hubspot</p>
	...
	<div class="container">
	  <div class="swiper-logo-carousel pt-lg-4 mt-12">
		<div class="swiper" id="swiper-clients-logos">
		  <div class="swiper-wrapper">
			<div class="swiper-slide">
			  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/branding/logo-1-light.png" alt="client logo" class="client-logo" data-app-light-img="front-pages/branding/logo-1-light.png" data-app-dark-img="front-pages/branding/logo-1-dark.png" />
			</div>
			<div class="swiper-slide">
			  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/branding/logo-2-light.png" alt="client logo" class="client-logo" data-app-light-img="front-pages/branding/logo-2-light.png" data-app-dark-img="front-pages/branding/logo-2-dark.png" />
			</div>
			<div class="swiper-slide">
			  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/branding/logo-3-light.png" alt="client logo" class="client-logo" data-app-light-img="front-pages/branding/logo-3-light.png" data-app-dark-img="front-pages/branding/logo-3-dark.png" />
			</div>
			<div class="swiper-slide">
			  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/branding/logo-4-light.png" alt="client logo" class="client-logo" data-app-light-img="front-pages/branding/logo-4-light.png" data-app-dark-img="front-pages/branding/logo-4-dark.png" />
			</div>
			<div class="swiper-slide">
			  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/branding/logo-5-light.png" alt="client logo" class="client-logo" data-app-light-img="front-pages/branding/logo-5-light.png" data-app-dark-img="front-pages/branding/logo-5-dark.png" />
			</div>
		  </div>
		</div>
	  </div>
  ...
  <section id="landingTeam" class="section-py landing-team">
	<div class="container bg-icon-right position-relative">
	  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/icons/bg-right-icon-light.png" alt="section icon" class="position-absolute top-0 end-0" data-speed="1" data-app-light-img="front-pages/icons/bg-right-icon-light.png" data-app-dark-img="front-pages/icons/bg-right-icon-dark.png" />
	  <h6 class="text-center d-flex justify-content-center align-items-center mb-6">
		<img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/icons/section-tilte-icon.png" alt="section title icon" class="me-2" height="19" />
		...
		<div class="col-lg-3 col-sm-6">
		  <div class="card card-hover-border-primary mt-4 mt-lg-0 shadow-none">
			<div class="bg-label-primary position-relative team-image-box">
			  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/landing-page/team-member-1.png" class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image" />
			</div>
		...
		<div class="col-lg-3 col-sm-6">
		  <div class="card card-hover-border-danger mt-4 mt-lg-0 shadow-none">
			<div class="bg-label-danger position-relative team-image-box">
			  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/landing-page/team-member-2.png" class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image" />
			</div>
			<div class="card-body text-center">
		...
		<div class="col-lg-3 col-sm-6">
		  <div class="card card-hover-border-success mt-4 mt-lg-0 shadow-none">
			<div class="bg-label-success position-relative team-image-box">
			  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/landing-page/team-member-3.png" class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image" />
			</div>
			<div class="card-body text-center">
		...
		<div class="col-lg-3 col-sm-6">
		  <div class="card card-hover-border-info mt-4 mt-lg-0 shadow-none">
			<div class="bg-label-info position-relative team-image-box">
			  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/landing-page/team-member-4.png" class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image" />
			</div>
			<div class="card-body text-center">
  ...
  <section id="landingPricing" class="section-py bg-body landing-pricing">
	<div class="container bg-icon-left position-relative">
	  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/icons/bg-left-icon-light.png" alt="section icon" class="position-absolute top-0 start-0" data-speed="1" data-app-light-img="front-pages/icons/bg-left-icon-light.png" data-app-dark-img="front-pages/icons/bg-left-icon-dark.png" />
	  <h6 class="text-center d-flex justify-content-center align-items-center mb-6">
		<img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/icons/section-tilte-icon.png" alt="section title icon" class="me-2" height="19" />
		...
		<div class="col-xl-4 col-lg-6">
		  <div class="card shadow-none">
			<div class="card-header border-0">
			  ...
			  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/icons/smiling-icon.png" alt="smiling icon" />
			</div>
			<div class="card-body">
			  <ul class="list-unstyled">
				<li>
				  <h5 class="mb-3">
					<img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/icons/list-arrow-icon.png" alt="list arrow icon" class="me-2 pe-1 scaleX-n1-rtl" />
					Timeline
				  </h5>
				</li>
				<li>
	  ...
	  <div class="row gy-5">
		<div class="col-lg-5">
		  <div class="text-center">
			<img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/landing-page/sitting-girl-with-laptop.png
  ...
  <section id="landingCTA" class="section-py landing-cta p-lg-0 pb-0 position-relative">
	<img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/backgrounds/cta-bg.png" class="position-absolute bottom-0 end-0 scaleX-n1-rtl h-100 w-100 z-n1" alt="cta image" />
	<div class="container">
	  <div class="row align-items-center gy-5 gy-lg-0">
		...
		<div class="col-lg-6 pt-lg-12">
		  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/landing-page/cta-dashboard.png" alt="cta dashboard" class="img-fluid" />
		</div>
	  </div>
	</div>
  </section>
		...
		<div class="col-lg-5">
		  <div class="card h-100">
			<div class="bg-primary rounded text-white card-body p-lg-8">
			  ...
			  <img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/landing-page/let’s-contact.png
...
<footer class="landing-footer">
  <div class="footer-top position-relative overflow-hidden">
	<img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/backgrounds/footer-bg.png" alt="footer bg" class="footer-bg banner-bg-img" />
...
<span style="color:#9055FD;">
  <svg width="30" height="24" viewBox="0 0 250 196" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<path fill-rule="evenodd" clip-rule="evenodd" d="M237.721 1.18923L125 70.3075V136.87L250 65.2465V8.06814C250 3.61223 246.389 0 241.935 0C240.448 0 238.99 0.411583 237.721 1.18923Z" fill="white" fill-opacity="0.3" />
		...
		<div class="col-lg-3 col-md-4">
		  ...
		  <a href="javascript:void(0);" class="d-block footer-link mb-4"><img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/landing-page/apple-icon.png" alt="apple icon" /></a>
		  <a href="javascript:void(0);" class="d-block footer-link"><img src="<?php echo site_url('assets/materio/') ?>/assets/img/front-pages/landing-page/google-play-icon.png" alt="google play icon" /></a>
		</div>
	  </div>
	</div>
  </div>
  <div class="footer-bottom py-5">
	<div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
	  ...
	  <div>
		<a href="https://github.com/themeselection" class="footer-link me-4" target="_blank"><i class="ri-github-fill"></i></a>
		<a href="https://www.facebook.com/ThemeSelections/" class="footer-link me-4" target="_blank"><i class="ri-facebook-circle-fill"></i></a>
		<a href="https://twitter.com/Theme_Selection" class="footer-link me-4" target="_blank"><i class="ri-twitter-fill"></i></a>
		<a href="https://www.instagram.com/themeselection/" class="footer-link" target="_blank"><i class='ri-instagram-line'></i></a>
	  </div>
	</div>
  </div>
</footer>
<!-- Footer: End -->
  ...
  <script src="<?php echo site_url('assets/materio/') ?>/assets/vendor/libs/popper/popper.js"></script>
  <script src="<?php echo site_url('assets/materio/') ?>/assets/vendor/js/bootstrap.js"></script>
  <script src="<?php echo site_url('assets/materio/') ?>/assets/vendor/libs/node-waves/node-waves.js"></script>
  
  <!-- endbuild -->

  <!-- Vendors JS -->
  <script src="<?php echo site_url('assets/materio/') ?>/assets/vendor/libs/nouislider/nouislider.js"></script>
<script src="<?php echo site_url('assets/materio/') ?>/assets/vendor/libs/swiper/swiper.js"></script>

  <!-- Main JS -->
  <script src="<?php echo site_url('assets/materio/') ?>/assets/js/front-main.js"></script>
  

  <!-- Page JS -->
  <script src="<?php echo site_url('assets/materio/') ?>/assets/js/front-page-landing.js"></script>
